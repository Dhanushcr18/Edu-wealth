  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="absolute top-20 left-20 w-72 h-72 bg-blue-400/20 rounded-full blur-3xl animate-pulse floating"></div>
        <div className="absolute bottom-40 right-20 w-96 h-96 bg-purple-400/20 rounded-full blur-3xl animate-pulse floating" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-pink-400/20 rounded-full blur-3xl animate-pulse floating" style={{animationDelay: '4s'}}></div>
      </div>
        ...
        <nav className="container-custom py-8 backdrop-blur-md bg-white/30 border-b border-white/20 sticky top-0 z-50">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3 group">
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 p-2 rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300 pulse-glow">
        ...
        <section className="container-custom py-24 md:py-32">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
              Skip one burger this month — invest in a course that pays back with <span className="font-bold text-purple-600">skills, knowledge, and opportunities</span> forever.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="text-4xl font-black bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">10K+</div>
                <div className="text-sm text-gray-600 font-medium">Active Students</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">500+</div>
                <div className="text-sm text-gray-600 font-medium">Quality Courses</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black bg-gradient-to-r from-pink-600 to-blue-600 bg-clip-text text-transparent mb-2">4.9★</div>
        ...
        <section className="container-custom py-32">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black text-gray-900 mb-4">
              Why Choose <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">EduWealth?</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card card-3d group p-10 text-center hover:scale-105 transition-all duration-500">
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-400 rounded-3xl blur-xl opacity-60 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl shadow-2xl">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our smart algorithm analyzes your interests and finds the <span className="font-semibold text-purple-600">perfect courses</span> tailored just for you.
              </p>
            </div>
            ...
            <div className="card card-3d group p-10 text-center hover:scale-105 transition-all duration-500" style={{transitionDelay: '100ms'}}>
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-emerald-400 rounded-3xl blur-xl opacity-60 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl shadow-2xl">
                  <CurrencyDollarIcon className="h-10 w-10 text-white" />
                </div>
              </div>
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Budget-Friendly</h3>
              <p className="text-gray-600 leading-relaxed">
                Set your budget and discover courses that fit. We help you <span className="font-semibold text-green-600">maximize value</span> for every rupee spent.
              </p>
            </div>
            ...
            <div className="card card-3d group p-10 text-center hover:scale-105 transition-all duration-500" style={{transitionDelay: '200ms'}}>
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-400 to-pink-400 rounded-3xl blur-xl opacity-60 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl shadow-2xl">
                  <SparklesIcon className="h-10 w-10 text-white" />
                </div>
              </div>
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Smart Insights</h3>
              <p className="text-gray-600 leading-relaxed">
                Track your spending, get <span className="font-semibold text-purple-600">personalized recommendations</span>, and make informed decisions about your education.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container-custom py-24">
          <div className="relative overflow-hidden gradient-bg rounded-[3rem] p-16 text-center text-white shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link to="/signup" className="btn bg-white text-purple-600 hover:bg-gray-100 px-10 py-4 text-lg font-bold shadow-2xl hover:shadow-3xl transform hover:scale-105">
                  Create Free Account
                </Link>
